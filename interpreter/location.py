...
class Location:
    ...
    def merge(begin: Self, end: Self):
        ...
        if end.startline < begin.startline or (begin.startline == end.startline and end.startcol < begin.startcol):  
        ...
        if begin.endline > end.endline or (end.endline == begin.endline and begin.endcol > end.endcol) :
            endcol = begin.endcol;
